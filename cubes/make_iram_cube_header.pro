...
; MAKE THE VELOCITY AXIS (ALONG THE THIRD DIMENSION)
  ...
  sxaddpar, hdr, 'SPECSYS', 'LSRK'
  sxaddpar, hdr, 'VELREF', 257
  if n_elements(restfreq) eq 0 then $
     restfreq = 230.538d9
  sxaddpar, hdr, 'RESTFRQ', restfreq
